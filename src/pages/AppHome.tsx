...
export default function AppHome() {
  return (
    <div className="min-h-full overflow-hidden bg-[radial-gradient(circle_at_top,_rgba(255,224,211,0.55),_transparent_45%),linear-gradient(180deg,_rgba(255,251,247,0.96)_0%,_rgba(255,246,239,0.88)_100%)] px-6 py-8 md:px-10 md:py-10">
      <div className="mx-auto grid max-w-6xl gap-6 lg:grid-cols-[minmax(0,0.84fr)_minmax(320px,1.16fr)] lg:items-center">
        <section className="max-w-2xl space-y-4">
          <h1 className="text-3xl font-bold tracking-tight">Welcome to Game Art Guidebook</h1>
        ...
        <section className="relative -ml-10 -mr-2 md:-ml-14 md:-mr-4 lg:-ml-24 lg:-mr-10">
          <HomeBookCanvas />
        </section>
      </div>
    </div>
